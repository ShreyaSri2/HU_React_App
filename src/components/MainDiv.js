    ...
    return(
        ...
        <div className="main-div">
            ...
            <div className="sub-div">
                ...
                <p className="headerCls">Heading</p>

                
                <div className="nav-bar">
                    <Link to='/'><button style={{width:"112px"}} className="btn">1.Choose Image</button></Link>
                    <Link to='/tab2'><button style={{width:"150px"}} className="btn">2.Choose Instance Type</button></Link>
                    <Link to='/tab3'><button className="btn">3.Choose Storage and Network</button></Link>
                    <Link to='/tab4'><button className="btn">4.Configure Security</button></Link>
                    <Link to='/tab5'><button className="btn">5.Review {'&'} Launch</button></Link>
                </div>
